...
var langArr = {
  ...
  aboutText: {
    ru: "Привет! Я занимаюсь разработкой сайтов любой сложности и веб-приложений. Также специализируюсь на веб-дизайне. Создаю не только красивый и уникальный продукт но и продающий. Опыт более 2-х лет. За это время помог реализовать идеи своих клиентов из Украины, Молдовы, Казахстана, Беларуси и России. В своей работе (frontend) использую такие технологии как HTML5, SCSS3, Bootstrap, JavaScript, JQuery, различные библиотеки Slick, Swiper, AOS и многое другое. Автоматизирую свой процесс разработки с помощью Gulp, Webpack. Также есть опыт с React JS. Есть опыт с backend частью - PHP. И это далеко не все на чем я готов остановиться.",
    en: "Hi! I am developing websites of any complexity and web applications. I also specialize in web design. I create not only a beautiful and unique product, but also a selling one. Over 2 years of experience. During this time, I helped to realize the ideas of my clients from Ukraine, Moldova, Kazakhstan, Belarus and Russia.In my work (frontend) I use technologies such as HTML5, SCSS3, Bootstrap, JavaScript, JQuery, various libraries Slick, Swiper, AOS and much more.I automate my development process using Gulp, Webpack.Also I have experience with React JS. I have experience with the backend part - PHP. And that's not all I'm ready to cover."
  },
  prioritiesTitle: {
    ru: "Приоритеты",
    en: "Priorities"
...
var tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]("portfolio");
