...
var scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_3___default())('a[href*="#"]'); // Подключение событий свайпа на мобильных
...
//const btnDownload = document.querySelector(".my-info__download-resume");
...
var progNum = document.querySelectorAll(".about__progress-num");
var progress = document.querySelectorAll(".about__progress-bar");
